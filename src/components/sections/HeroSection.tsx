    ...
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden">
      ...
      <div className="relative z-10 text-center text-white px-4 sm:px-6 max-w-5xl mx-auto">
        ...
        <div className="flex flex-col sm:flex-row gap-4 justify-center">
          <Link
            href="/pnixta"
            className="px-8 py-4 lg:px-10 lg:py-5 bg-amber-500 hover:bg-amber-400 text-white font-semibold rounded-xl transition-all hover:scale-105 text-sm sm:text-base lg:text-lg shadow-lg shadow-amber-500/30"
          >
            피닉타 페스타 알아보기 →
          </Link>
          <Link
            href="/membership/apply"
            className="px-8 py-4 lg:px-10 lg:py-5 bg-white/10 hover:bg-white/20 backdrop-blur-sm text-white font-semibold rounded-xl border border-white/30 transition-all hover:scale-105 text-sm sm:text-base lg:text-lg"
          >
            회원가입
          </Link>
        </div>
